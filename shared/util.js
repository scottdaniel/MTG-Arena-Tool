...
function toMMSS(sec_num) {
    var hours   = Math.max(0, Math.floor(sec_num / 3600));
    var minutes = Math.max(0, Math.floor((sec_num - (hours * 3600)) / 60));
    var seconds = Math.max(0, sec_num - (hours * 3600) - (minutes * 60));
